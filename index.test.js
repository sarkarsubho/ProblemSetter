...
describe("testing 2nd Function, promoted and not promoted  students.",()=>{
  ...
  test("should return the correct answer for totalPromoted", () => {
    expect(checkPromoted(mockData).totalPromoted).toEqual(mockAns.totalPromoted);
  });

  test("should return the correct answer for totalPromotedAvgAge", () => {
    expect(checkPromoted(mockData).totalPromotedAvgAge).toEqual(mockAns.totalPromotedAvgAge);
  });

  test("should return the correct answer for totalPromotedUnder15", () => {
    expect(checkPromoted(mockData).totalPromotedUnder15).toEqual(mockAns.totalPromotedUnder15);
  });


  test("should return the correct answer for totalAgePromotedMale", () => {
    expect(checkPromoted(mockData).totalAgePromotedMale).toEqual(mockAns.totalAgePromotedMale);
  });

  test("should return the correct answer for totalPromotedFemaleAscByAge ascending value", () => {
    expect(checkPromoted(mockData).totalPromotedFemaleAscByAge[0]).toEqual(mockAns.totalPromotedFemaleAscByAge[0]);
  });

  test("should return the correct answer for totalPromotedFemaleAscByAge ascending value2", () => {
    expect(checkPromoted(mockData).totalPromotedFemaleAscByAge[1]).toEqual(mockAns.totalPromotedFemaleAscByAge[1]);
  });
